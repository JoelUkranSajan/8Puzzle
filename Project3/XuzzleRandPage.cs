...
namespace Project3
{
	...
	class XuzzleRandPage : ContentPage
	{
		...
		public XuzzleRandPage()
		{
			...
			//stream = assembly.GetManifestResourceStream("Project3.BadWordsBannedByGoogle.txt");
			//reader = new System.IO.StreamReader(stream);

			// Read lines.
			lines = new string[] { "Justincooper", "Sampskb", "akdnnsdk", "ajsbdjk", "asjhdkjd", "sjbjkrgdflaow" };
